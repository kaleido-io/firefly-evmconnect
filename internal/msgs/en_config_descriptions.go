...
var (
	...
	ConfigRPCBatchMaxConcurrentRequests = ffc("config.connector.maxConcurrentRequests", "The maximum number of concurrent JSON-RPC requests get processed at a time", i18n.IntType)
	ConfigRPCBatchEnabled               = ffc("config.connector.batch.enabled", "Whether to enable batching JSON-RPC requests", i18n.BooleanType)
